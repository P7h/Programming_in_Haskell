...
-- doubleSecond (x:xs:ys)  = x : xs*2 : doubleSecond ys
...
isValid n | n == 0    = False
          | n > 0     = (sumDigits (doubleSecond (toDigits n))) `mod` 10 == 0
...
-- List all valid cards
-- numValid :: [Integer] -> [Integer]
-- numValid xs = filter isValid xs
